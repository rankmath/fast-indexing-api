...
<div class="wrap rank-math-wrap">
	...
	<form enctype="multipart/form-data" method="POST" action="">
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row">
					<?php esc_html_e( 'JSON Key:', 'fast-indexing-api' ); ?>
			...
			<tr valign="top">
				<th scope="row">
					<?php esc_html_e( 'Post Types:', 'fast-indexing-api' ); ?>
					<p class="description"><?php esc_html_e( 'Submit posts from these post types automatically in the background when a post is published, edited, or deleted. Also adds action links to submit manually.', 'fast-indexing-api' ); ?></p>
				</th>
