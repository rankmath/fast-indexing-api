...
namespace Rank_Math_Instant_Indexing\Psr\Log\Test;

use Rank_Math_Instant_Indexing\Psr\Log\LoggerInterface;
use Rank_Math_Instant_Indexing\Psr\Log\LogLevel;
use Rank_Math_Instant_Indexing\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Rank_Math_Instant_Indexing\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Rank_Math_Instant_Indexing\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Rank_Math_Instant_Indexing\Psr\Log\Test\DummyTest', array('__toString'));
        }
