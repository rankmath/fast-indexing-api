...
use Rank_Math_Instant_Indexing\GuzzleHttp\Cookie\CookieJar;
use Rank_Math_Instant_Indexing\GuzzleHttp\Exception\GuzzleException;
use Rank_Math_Instant_Indexing\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Rank_Math_Instant_Indexing\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
