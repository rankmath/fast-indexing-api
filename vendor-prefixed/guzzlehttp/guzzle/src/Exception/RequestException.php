...
namespace Rank_Math_Instant_Indexing\GuzzleHttp\Exception;

use Rank_Math_Instant_Indexing\GuzzleHttp\BodySummarizer;
use Rank_Math_Instant_Indexing\GuzzleHttp\BodySummarizerInterface;
use Rank_Math_Instant_Indexing\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \Rank_Math_Instant_Indexing\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
