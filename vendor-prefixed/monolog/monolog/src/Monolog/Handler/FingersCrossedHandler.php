...
use Rank_Math_Instant_Indexing\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Rank_Math_Instant_Indexing\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
