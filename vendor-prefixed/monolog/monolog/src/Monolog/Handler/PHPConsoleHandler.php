...
use Rank_Math_Instant_Indexing\Monolog\Formatter\LineFormatter;
use Rank_Math_Instant_Indexing\Monolog\Formatter\FormatterInterface;
use Rank_Math_Instant_Indexing\Monolog\Logger;
use Rank_Math_Instant_Indexing\Monolog\Utils;
use Rank_Math_Instant_Indexing\PhpConsole\Connector;
use Rank_Math_Instant_Indexing\PhpConsole\Handler as VendorPhpConsoleHandler;
use Rank_Math_Instant_Indexing\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('Rank_Math_Instant_Indexing\PhpConsole\Connector')) {
