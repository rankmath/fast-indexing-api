 ...
 */
namespace Rank_Math_Instant_Indexing\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('Rank_Math_Instant_Indexing\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
