...
use Rank_Math_Instant_Indexing\Swift_Message;
use Rank_Math_Instant_Indexing\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\Rank_Math_Instant_Indexing\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
