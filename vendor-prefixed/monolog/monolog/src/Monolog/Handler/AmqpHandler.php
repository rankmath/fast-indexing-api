...
use Rank_Math_Instant_Indexing\Monolog\Formatter\JsonFormatter;
use Rank_Math_Instant_Indexing\PhpAmqpLib\Message\AMQPMessage;
use Rank_Math_Instant_Indexing\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
