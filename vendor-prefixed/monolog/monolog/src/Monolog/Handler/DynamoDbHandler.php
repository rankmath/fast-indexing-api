...
use Rank_Math_Instant_Indexing\Aws\Sdk;
use Rank_Math_Instant_Indexing\Aws\DynamoDb\DynamoDbClient;
use Rank_Math_Instant_Indexing\Monolog\Formatter\FormatterInterface;
use Rank_Math_Instant_Indexing\Aws\DynamoDb\Marshaler;
use Rank_Math_Instant_Indexing\Monolog\Formatter\ScalarFormatter;
...
class DynamoDbHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(DynamoDbClient $client, string $table, $level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        if (defined('Rank_Math_Instant_Indexing\Aws\Sdk::VERSION') && version_compare(Sdk::VERSION, '3.0', '>=')) {
            $this->version = 3;
