 ...
 */
namespace Rank_Math_Instant_Indexing\phpseclib3\Math\BigInteger\Engines\PHP;

use Rank_Math_Instant_Indexing\phpseclib3\Math\BigInteger\Engines\Engine;
use Rank_Math_Instant_Indexing\phpseclib3\Math\BigInteger\Engines\PHP;
use Rank_Math_Instant_Indexing\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
