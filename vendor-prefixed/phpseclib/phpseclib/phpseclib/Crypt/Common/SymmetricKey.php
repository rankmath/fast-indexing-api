 ...
 */
namespace Rank_Math_Instant_Indexing\phpseclib3\Crypt\Common;
...
use Rank_Math_Instant_Indexing\phpseclib3\Exception\BadDecryptionException;
use Rank_Math_Instant_Indexing\phpseclib3\Exception\BadModeException;
use Rank_Math_Instant_Indexing\phpseclib3\Exception\InconsistentSetupException;
...
use Rank_Math_Instant_Indexing\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
