 ...
 */
namespace Rank_Math_Instant_Indexing\phpseclib3\Crypt\EC\BaseCurves;
...
use Rank_Math_Instant_Indexing\phpseclib3\Math\Common\FiniteField\Integer;
use Rank_Math_Instant_Indexing\phpseclib3\Math\PrimeField;
use Rank_Math_Instant_Indexing\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
