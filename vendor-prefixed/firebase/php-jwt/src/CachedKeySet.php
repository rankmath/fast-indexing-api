...
namespace Rank_Math_Instant_Indexing\Firebase\JWT;

use ArrayAccess;
use InvalidArgumentException;
use LogicException;
use OutOfBoundsException;
use Rank_Math_Instant_Indexing\Psr\Cache\CacheItemInterface;
use Rank_Math_Instant_Indexing\Psr\Cache\CacheItemPoolInterface;
use Rank_Math_Instant_Indexing\Psr\Http\Client\ClientInterface;
