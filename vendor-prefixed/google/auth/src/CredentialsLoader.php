...
use Rank_Math_Instant_Indexing\Google\Auth\Credentials\ExternalAccountCredentials;
use Rank_Math_Instant_Indexing\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Rank_Math_Instant_Indexing\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        $stack = \Rank_Math_Instant_Indexing\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \Rank_Math_Instant_Indexing\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
