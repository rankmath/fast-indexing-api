 ...
 */
namespace Rank_Math_Instant_Indexing\Google;

use BadMethodCallException;
use DomainException;
use Rank_Math_Instant_Indexing\Google\AccessToken\Revoke;
use Rank_Math_Instant_Indexing\Google\AccessToken\Verify;
use Rank_Math_Instant_Indexing\Google\Auth\ApplicationDefaultCredentials;
use Rank_Math_Instant_Indexing\Google\Auth\Cache\MemoryCacheItemPool;
use Rank_Math_Instant_Indexing\Google\Auth\Credentials\ServiceAccountCredentials;
use Rank_Math_Instant_Indexing\Google\Auth\Credentials\UserRefreshCredentials;
use Rank_Math_Instant_Indexing\Google\Auth\CredentialsLoader;
use Rank_Math_Instant_Indexing\Google\Auth\FetchAuthTokenCache;
use Rank_Math_Instant_Indexing\Google\Auth\GetUniverseDomainInterface;
use Rank_Math_Instant_Indexing\Google\Auth\HttpHandler\HttpHandlerFactory;
use Rank_Math_Instant_Indexing\Google\Auth\OAuth2;
use Rank_Math_Instant_Indexing\Google\AuthHandler\AuthHandlerFactory;
use Rank_Math_Instant_Indexing\Google\Http\REST;
use Rank_Math_Instant_Indexing\GuzzleHttp\Client as GuzzleClient;
use Rank_Math_Instant_Indexing\GuzzleHttp\ClientInterface;
use Rank_Math_Instant_Indexing\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Rank_Math_Instant_Indexing\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Rank_Math_Instant_Indexing\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use Rank_Math_Instant_Indexing\Monolog\Logger;
use Rank_Math_Instant_Indexing\Psr\Cache\CacheItemPoolInterface;
use Rank_Math_Instant_Indexing\Psr\Http\Message\RequestInterface;
use Rank_Math_Instant_Indexing\Psr\Http\Message\ResponseInterface;
use Rank_Math_Instant_Indexing\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (defined('Rank_Math_Instant_Indexing\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('Rank_Math_Instant_Indexing\GuzzleHttp\ClientInterface::VERSION')) {
