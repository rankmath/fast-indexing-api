 ...
 */
namespace Rank_Math_Instant_Indexing\Google\Http;

use Rank_Math_Instant_Indexing\Google\Auth\HttpHandler\HttpHandlerFactory;
use Rank_Math_Instant_Indexing\Google\Service\Exception as GoogleServiceException;
use Rank_Math_Instant_Indexing\Google\Task\Runner;
...
use Rank_Math_Instant_Indexing\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (interface_exists('Rank_Math_Instant_Indexing\GuzzleHttp\Message\ResponseInterface') && $response instanceof \Rank_Math_Instant_Indexing\GuzzleHttp\Message\ResponseInterface) {
