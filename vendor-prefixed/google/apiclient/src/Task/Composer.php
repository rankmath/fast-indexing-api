 ...
 * the License.
 */
namespace Rank_Math_Instant_Indexing\Google\Task;

use Rank_Math_Instant_Indexing\Composer\Script\Event;
use InvalidArgumentException;
use Rank_Math_Instant_Indexing\Symfony\Component\Filesystem\Filesystem;
use Rank_Math_Instant_Indexing\Symfony\Component\Finder\Finder;
class Composer
{
    /**
