 ...
 * the License.
 */
namespace Rank_Math_Instant_Indexing\Google\Service\Indexing;

class PublishUrlNotificationResponse extends \Rank_Math_Instant_Indexing\Google\Model
{
...
class_alias(PublishUrlNotificationResponse::class, 'Rank_Math_Instant_Indexing\Google_Service_Indexing_PublishUrlNotificationResponse');
