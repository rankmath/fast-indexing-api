...
class UrlNotificationMetadata extends \Rank_Math_Instant_Indexing\Google\Model
{
...
class_alias(UrlNotificationMetadata::class, 'Rank_Math_Instant_Indexing\Google_Service_Indexing_UrlNotificationMetadata');
