 ...
 * the License.
 */
namespace Rank_Math_Instant_Indexing\Google\Service\Indexing\Resource;

use Rank_Math_Instant_Indexing\Google\Service\Indexing\PublishUrlNotificationResponse;
use Rank_Math_Instant_Indexing\Google\Service\Indexing\UrlNotification;
use Rank_Math_Instant_Indexing\Google\Service\Indexing\UrlNotificationMetadata;
/**
 ...
 *  </code>
 */
class UrlNotifications extends \Rank_Math_Instant_Indexing\Google\Service\Resource
{
    /**
...
class_alias(UrlNotifications::class, 'Rank_Math_Instant_Indexing\Google_Service_Indexing_Resource_UrlNotifications');
